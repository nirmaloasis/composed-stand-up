...
var TextArea = function (_Component) {
  ...
  function TextArea() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = TextArea.__proto__ || Object.getPrototypeOf(TextArea)).call.apply(_ref, [this].concat(args))), _this), _this.state = {}, _this.focus = function () {
      ...
      var boxModelHeight = (0, _sum3.default)([borderBottomWidth, borderTopWidth, paddingBottom, paddingTop].map(function (x) {
        return parseFloat(x);
      }));
  ...
  (0, _createClass3.default)(TextArea, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(ElementType, (0, _extends3.default)({}, rest, {
        ...
        ref: this.handleRef,
        rows: rows,
        style: (0, _extends3.default)({ height: height, resize: resize }, style),
        value: value
      }));
    }
  }]);
