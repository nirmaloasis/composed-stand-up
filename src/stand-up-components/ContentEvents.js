...
export default class ContentEvents extends React.Component {
        ...
        if(this.memberSelectedEvent.value== ""){
            ...
            if(getDate =="" || (Object.prototype.toString.call(new Date(getDate)) === '[object Date]' && isFinite(new Date(getDate)))){
                ...
                if(newEvent.length == 0){
                    ...
                    var index,newDate = new Date(newEvent[0].date)                          
                    ...
                    events.splice(index, 0, newEvent[0])
                    this.state.action = "normal"
  ...
  render() {
    ...
    var bodyBottomHeight = (this.props.windowHeight - bodyTopHeight - 70)
    return (
                ...
                return(
                    <div key={i} className="InfoTilesWrapper EventTilePaddingB" data-id={i}>
                        <div className="EditCloseIcon">
                            ...
                            <span className="IconsSpan" onClick={(event)=>this.returnToHomeTile(event,i)}><img className="Icons" src="images/previous.svg" alt="return"/><span className="ToolTipText">return</span></span>
                        </div>
                        {   
