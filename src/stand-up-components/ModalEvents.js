                ...
                return(
                    <div key={i} className="InfoTilesWrapper EventTilePaddingB" data-id={i}>
                        <div className="EditCloseIcon">
                            ...
                            <span className="IconsSpan" onClick={(event)=>this.helpDetails(event,i)}>{val.eventDetails ? <img className="NotificationIconModal" src="images/comment-icon.png" alt="details" />: ""}<img className="ModalIcons" src="images/details.svg" alt="details" /><span className="ToolTipText ModalToolTipFont">details</span></span>
